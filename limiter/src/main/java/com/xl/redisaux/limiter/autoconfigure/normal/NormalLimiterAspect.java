...
import com.xl.redisaux.limiter.annonations.normal.LimiterType;
...
public class NormalLimiterAspect {
    ...
    @Pointcut("@annotation(com.xl.redisaux.limiter.annonations.normal.TokenLimiter)||@annotation(com.xl.redisaux.limiter.annonations.normal.WindowLimiter)||@annotation(com.xl.redisaux.limiter.annonations.normal.FunnelLimiter)")
